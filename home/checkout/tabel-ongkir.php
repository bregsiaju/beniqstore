...
$kurir = $_POST['kurir'];
$berat = 250; //Berat barang menggunakan satuan gram
...
?>
   <div title="<?php echo strtoupper($data['rajaongkir']['results'][$k]['name']); ?>" style="padding:10px">
      <table border="1" class="text-center w-75">
         <tr>
            <th>No.</th>
            <th>Jenis Layanan</th>
            <th>ETD</th>
         ...
         ?>
            <tr>
               ...
               <td align="right"><?php echo number_format($data['rajaongkir']['results'][$k]['costs'][$l]['cost'][0]['value'], 0, '', '.'); ?></td>
               <td>
...
<script type="text/javascript">
   $('.pilih_ongkir').on('click', function() {
      ...
      var tarifss = format_rupiah(tarif);

      $('#ongkir').text('Rp' + tarifss);
